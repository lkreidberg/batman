...
static PyObject *occultnlMA(PyObject *self, PyObject *args)
{
/*	Comments here
*/
...
static char occultnlMA_doc[] = "LK 05/2015";

static PyMethodDef occultnlMA_methods[] = {
  {"occultnlMA", occultnlMA, METH_VARARGS, occultnlMA_doc},{NULL}};

void initoccultnlMA(void)
{
  Py_InitModule("occultnlMA", occultnlMA_methods);
  import_array();
}
