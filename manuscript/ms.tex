...
\texttt{batman} also provides utilities to calculate the time of periastron and the secondary eclipse time from the other transit parameters, using the method described in \S 3.1 of \cite{eastman13}.
