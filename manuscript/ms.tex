...
\texttt{batman} provides utilities to calculate the time of periastron, time of inferior conjunction, and the secondary eclipse time from the other transit parameters, using the method described in \S 3.1 of \cite{eastman13}.  Note however that ``batman`` does not correct for the effects of light travel time.
